...
- I'm probably not going to start doing professional work in PHP—the language is interesting feels kludgy to me, and the value of the defaults diminishes as a greater percentage of the code becomes business logic—but I am definitely going to do more web art in PHP. I especially like how compact and shareable it can be, which has tremendous value for certain types of code.
